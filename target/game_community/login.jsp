...
<div id="con1" class="container center-block">
    ...
    <div class="row form-group center-block" >
        <div class="col-md-2 col-md-offset-4 col-sm-4 col-sm-offset-4" hidden>
        <label for="vcode">验证码：</label>
        <input type="text" name="verifycode" class="form-control" id="verifycode" placeholder="请输入验证码">
        <a href="javascript:refreshCode()"><img style="color: #0a04d5" src="${pageContext.request.contextPath}/CheckCodeServlet" title="看不清点击刷新" id="vcode"/></a>
        </div>
    </div>
    <div class="row form-group center-block">
        <div class="col-md-4 col-md-offset-4 col-sm-4  col-sm-offset-4">
            <button type="button" id="bt1" class="btn btn-primary btn-block">点击登录</button>
        </div>
    </div>
    <div class="row" id="register">
        <div >
            <a class="col-md-2 col-md-offset-4 col-sm-4  col-sm-offset-2" href="" style="color:#3359de">忘记账号或者密码了?</a>
